...
public class FamilyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WordAdapter WordView = new WordAdapter(this, fam, R.color.category_family);
...
// with the current word
                    mediaPlayer = MediaPlayer.create(FamilyActivity.this, words.getmMusicResID());
                    mediaPlayer.start();
